const APIController = (function() {
    ...
    // "https://api.spotify.com/v1/me/player/queue?uri=spotify%3Atrack%3A4iV5W9uYEdYUVa79Axb7Rh&device_id=0ae8cd7d953c7a891f53e3ce6e0ae526ea16fa35"
...
const APPController = (function(UICtrl, APICtrl) {
    ...
    DOMInputs.tracks.addEventListener('click', async (e) => {
        ...
        // add track to queue
        await APICtrl.addToQueue(token, track.uri);
    });    
